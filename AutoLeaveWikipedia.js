...
window.AutoLeave=async function(){
    ...
    LeaveWindow.onload=function(){try{LeaveWindow.document.querySelector(".oo-ui-inputWidget-input.oo-ui-buttonElement-button").click()}catch(e){};LeaveWindow.close()}
    if(window.bansite){window.bansite();unbansite()}
}
